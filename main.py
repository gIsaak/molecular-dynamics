...
d_saver_10 = np.zeros(shape=(1000)) # shape = number_of_timesteps
...
for count, t in enumerate(T_010): 
    MDS_parameters = {
    
    # Simulation
    'number_of_timesteps':  1000,   # Number of evolutions performed after equilibrium is reached.
